"""
Django settings for aaa_40421 project.
...
WSGI_APPLICATION = 'aaa_40421.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aaa_40421 API",
    "DESCRIPTION": "API documentation for aaa_40421 App",
    "VERSION": "v1",
}
